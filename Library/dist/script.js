...
/* harmony import */ var _modules_manipulation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/manipulation */ "./src/js/lib/modules/manipulation.js");
...
/***/ "./src/js/lib/modules/manipulation.js":
/*!********************************************!*\
  !*** ./src/js/lib/modules/manipulation.js ***!
  \********************************************/
/*! no exports provided */
...
_core__WEBPACK_IMPORTED_MODULE_2__["default"].prototype.addClasses = function (...selector) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_2__["default"].prototype.removeClasses = function (...selector) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_2__["default"].prototype.addClass = function (selector) {
  for (let i = 0; i < this.length; i++) {
    this[i].classList.add(selector);
  }
...
_core__WEBPACK_IMPORTED_MODULE_2__["default"].prototype.removeClass = function (selector) {
  for (let i = 0; i < this.length; i++) {
    this[i].classList.remove(selector);
  }
...
_core__WEBPACK_IMPORTED_MODULE_2__["default"].prototype.toggleClass = function (selector) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_2__["default"].prototype.hasClass = function (className) {
  if (className) {
    for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_2__["default"].prototype.attr = function (key, value) {
  if (key && !value) {
    for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_2__["default"].prototype.removeAttr = function (key) {
  if (key) {
    for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_2__["default"].prototype.val = function (newValue) {
  if (newValue) {
    for (let i = 0; i < this.length; i++) {
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.input').val('value');
console.log(Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.input').val());
