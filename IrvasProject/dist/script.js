...
/* harmony import */ var _modules_changeModal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/changeModal */ "./src/js/modules/changeModal.js");
/* harmony import */ var _modules_timer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/timer */ "./src/js/modules/timer.js");
/* harmony import */ var _modules_imagesModal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/imagesModal */ "./src/js/modules/imagesModal.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var dataModal = {};
  var deadline = '2020-06-15';
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(dataModal);
  Object(_modules_validate__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_changeModal__WEBPACK_IMPORTED_MODULE_5__["default"])(dataModal);
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.container1', deadline);
  Object(_modules_imagesModal__WEBPACK_IMPORTED_MODULE_7__["default"])();
});
...
var changeModal = function changeModal(state) {
  var calcForm = document.querySelectorAll('.balcon_icons_img'),
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              ...
              if (item.getAttribute('data-measurement') === true) {
                state[name] = "".concat(item.value, " \u043C\u043C");
              } else {
                state[name] = "".concat(item.value);
              }
            }
...
var forms = function forms(state) {
  ...
  forms.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      sendData('assets/server.php', formData).then(function (data) {
        console.log(data);
...
var timer = function timer(id, deadline) {
  ...
  function getTimeRemaining(endtime) {
    var remain = Date.parse(deadline) - Date.parse(new Date()),
