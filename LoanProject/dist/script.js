...
/* harmony import */ var _modules_slides_slider_main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/slides/slider-main */ "./src/js/modules/slides/slider-main.js");
/* harmony import */ var _modules_slides_slider_mini__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/slides/slider-mini */ "./src/js/modules/slides/slider-mini.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (windowWidth >= 1026) {
    ...
    var modulesMainSlider = new _modules_slides_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
      container: '.moduleapp',
      next: '.next',
      prev: '.prev'
    });
    modulesMainSlider.render();
    var previewModulesSlider = new _modules_slides_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
    ...
    var previewShowUpSlider = new _modules_slides_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
    ...
    var previewFeedSlider = new _modules_slides_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
    ...
    var videoPlayer = new _modules_videoPlayer_videoPlayer__WEBPACK_IMPORTED_MODULE_2__["default"]('.play', '.overlay');
    videoPlayer.render();
    var modulesVideoPlayer = new _modules_videoPlayer_videoPlayer__WEBPACK_IMPORTED_MODULE_2__["default"]('.play', '.overlay');
    ...
    difference.render();
    var sendResourse = new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]({
      form: 'form',
      input: 'input',
...
function () {
  function Difference(_ref) {
    var _ref$oldWrap = _ref.oldWrap,
        oldWrap = _ref$oldWrap === void 0 ? null : _ref$oldWrap,
        _ref$newWrap = _ref.newWrap,
        newWrap = _ref$newWrap === void 0 ? null : _ref$newWrap;
...
/* harmony import */ var _requests__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./requests */ "./src/js/modules/requests.js");
/* harmony import */ var _validateInputs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./validateInputs */ "./src/js/modules/validateInputs.js");
...
function () {
  function SendResourse(_ref) {
    ...
    _classCallCheck(this, SendResourse);
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          var createRequest = new _requests__WEBPACK_IMPORTED_MODULE_4__["default"](formData, _this.path);
          createRequest.render().then(function (result) {
            console.log(result);
...
/* harmony default export */ __webpack_exports__["default"] = (SendResourse);
      ...
      return regeneratorRuntime.async(function init$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return regeneratorRuntime.awrap(fetch("".concat(this.url), {
                method: 'POST',
                body: this.data
              }));
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return regeneratorRuntime.awrap(this.init());
...
/***/ "./src/js/modules/slides/slider-main.js":
/*!**********************************************!*\
  !*** ./src/js/modules/slides/slider-main.js ***!
  \**********************************************/
/*! exports provided: default */
...
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./slider */ "./src/js/modules/slides/slider.js");
...
function (_Slider) {
  ...
  function SliderMain(container, next, prev, slideIndex) {
    _classCallCheck(this, SliderMain);

    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMain).call(this, container, next, prev, slideIndex));
  }

  _createClass(SliderMain, [{
    key: "optionsSlides",
    value: function optionsSlides() {
      var _this = this;
      ...
      this.slides.forEach(function (item) {
        ...
        _this.slides[i].classList.remove('animated', 'fadeInLeft');
      });
      ...
      if (this.slideIndex === 2) {
        setTimeout(function () {
          try {
            ...
            _this.hanson.classList.add('animated', 'fadeInLeft');
          } catch (e) {}
        }, 3000);
      } else {
        try {
    ...
    value: function editSlides() {
      ...
      this.next.forEach(function (next) {
        next.addEventListener('click', function () {
          ...
          _this2.optionsSlides(_this2.slideIndex);
        });
      });
...
/***/ "./src/js/modules/slides/slider-mini.js":
/*!**********************************************!*\
  !*** ./src/js/modules/slides/slider-mini.js ***!
  \**********************************************/
/*! exports provided: default */
...
function (_Slider) {
  ...
  function SliderMini(container, next, prev, activeClass, autoPlay, animate) {
    _classCallCheck(this, SliderMini);

    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMini).call(this, container, next, prev, activeClass, autoPlay, animate));
  }
...
/* harmony default export */ __webpack_exports__["default"] = (SliderMini);

/***/ }),

/***/ "./src/js/modules/slides/slider.js":
/*!*****************************************!*\
  !*** ./src/js/modules/slides/slider.js ***!
  \*****************************************/
/*! exports provided: default */
...
function () {
  function ValidateInputs(_ref) {
    var _ref$inputsNumber = _ref.inputsNumber,
        inputsNumber = _ref$inputsNumber === void 0 ? null : _ref$inputsNumber,
        _ref$inputsString = _ref.inputsString,
        inputsString = _ref$inputsString === void 0 ? null : _ref$inputsString;

    _classCallCheck(this, ValidateInputs);
  ...
  _createClass(ValidateInputs, [{
    key: "clearSymbol",
    value: function clearSymbol() {
      this.inputsString.forEach(function (item) {
        item.addEventListener('input', function (e) {
          item.value = item.value.replace(/\d/, '');
        });
      });
      this.inputsNumber.forEach(function (item) {
        item.addEventListener('input', function (e) {
...
/***/ "./src/js/modules/videoPlayer/videoPlayer.js":
/*!***************************************************!*\
  !*** ./src/js/modules/videoPlayer/videoPlayer.js ***!
  \***************************************************/
/*! exports provided: default */
        ...
        btn.addEventListener('click', function () {
          ...
          if (!btn.closest('.module__video-item') || btn.closest('.module__video-item').getAttribute('data-disabled') !== 'true') {
            if (document.querySelector('iframe#frame')) {
              _this2.popup.style.display = 'flex';
