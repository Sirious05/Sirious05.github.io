...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var mainSlider = new _modules_slides_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.page',
    next: '.next'
  });
  mainSlider.render();
  var modulesSlider = new _modules_slides_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  var showUpSlider = new _modules_slides_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  modulesSlider.render();
  var feedSlider = new _modules_slides_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
...
function (_Slider) {
  ...
  function SliderMain(container, next, slideIndex) {
    _classCallCheck(this, SliderMain);

    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMain).call(this, container, next, slideIndex));
  }
      ...
      this.triggers.forEach(function (item) {
        item.addEventListener('click', function () {
          if (document.querySelector('iframe#frame')) {
            ...
            _this2.popup.classList.add('animated', 'fadeInLeft');
          } else {
